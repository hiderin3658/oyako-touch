...
/** 演出状態に応じてクラス名を組み立てる */
function buildClassName(state: AnimalChoiceProps["state"]): string {
  return [
    styles.choice,
...
/** どうぶつの選択肢（動物イラスト画像）。ラベルは button の aria-label に集約 */
export function AnimalChoice({ choice, state, onSelect }: AnimalChoiceProps) {
  return (
    <button
      type="button"
